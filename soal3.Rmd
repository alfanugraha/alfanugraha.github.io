...
RKU <- function(data.x, data.y){
  ...
  # Memilih komponen utama dengan akar ciri >= 1 
  ...
  beta.X <- V[,1:max(k)] %*% as.matrix(beta.pcr[1:max(k)]) #melakukan transformasi peubah komponen utama menjadi peubah asal x 
...
6. Menghitung intercept penduga parameter regresi komponen utama yang sudah ditransformasi balik untuk peubah X \
...
$\hat Y = 10.201317+4.969183X_1+4.967531X_2+4.969279X_3$
