...
1. Bangkitkanlah data populasi yang terdiri atas 1000 amatan dengan peubah: 
   a. No : 1 sd 500, 9001 sd 9500 (integer) 
   b. ID : G0001 sd G0500, G9001 sd G9500 (diperoleh berdasarkan kolom No, dengan penambahan huruf “G” didepan No dan jumlah digitnya harus 4) 
   c. Kelas : "Paralel 1" jika ID genap, dan "Paralel 2" jika ID ganjil (factor) 
   d. UTS : Diperoleh dengan membangkitkan bilangan acak yang menyebar $N(\mu = 70, \sigma= 25)$ 
   e. Indeks : Diperoleh dengan membangkitkan bilangan acak yang menyebar $Exponential(\theta = 1)$ 
2. Hilangkan data peubah Indeks yang bernilai lebih dari 1 (menjadi missing value) 
3. Hitunglah rata-rata dari UTS yang memiliki indeks 
4. Buatlah data sampel berukuran 100 amatan dari Kelas "Paralel 1" yang memiliki indeks 
5. Hitunglah rata-rata dari UTS pada data sampel yang terambil, lalu bandingkan dengan populasi 
...
### Menghitung rata-rata UTS yang memiliki indeks
...
### Menarik 100 sampel kelas Paralel 1 yang memiliki indeks
...
Rata-rata dari 100 sampel acak yang dipilh tidak jauh berbeda dengan rata-rata populasi, rata-rata dari populasi adalah 70.09699, dan rata-rata sampel adalah 71.34412.